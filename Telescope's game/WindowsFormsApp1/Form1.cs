...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
            ...
            for (int index = 0; index < 5; index++)
            {
                ...
                for (int noOfRows = 0; noOfRows < noOfColumnsInRow[index]; noOfRows++)
                {
                    ...
                    else
                    {
                        ...
                        hexagons[noOfHex].ImageLocation = "C:/Users/alexisja/Desktop/NASA/hexagon_flashing.png";
        ...
        private void all_hex_click_handler(object sender, EventArgs e, int validHex, int count)
        {
            ...
            //if (validHex != -1)
            {
                hexagons[currentHex].ImageLocation = "C:/Users/alexisja/Desktop/NASA/hexagon_no_bg_2.png";
                hexagons[currentHex].Visible = true;
        ...
        private void reset_planet_Click(object sender, EventArgs e)
        {
            ...
            {
                hexagons[index].ImageLocation = "C:/Users/alexisja/Desktop/NASA/hexagon_flashing.png";
